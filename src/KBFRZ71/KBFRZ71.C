...
//                      |         |  Shift  |  Ctrl   | S+Ctrl  | RMenu   | S+Remnu |
//                      |=========|=========|=========|=========|=========|=========|
  {'1'          ,SGCAPS ,0x00e0   ,'1'      ,WCH_NONE ,WCH_NONE ,0x00a7   ,0x00c0   },
  {'1'          ,0      ,0x00c0   ,'1'      },
  {'2'          ,SGCAPS ,0x00e9   ,'2'      ,WCH_NONE ,WCH_NONE ,WCH_DEAD ,0x00c9   },
  {0xff         ,0      ,0x00c9   ,'2'      ,WCH_NONE ,WCH_NONE ,0x00b4   ,WCH_NONE },
  {'3'          ,SGCAPS ,0x00e8   ,'3'      ,WCH_NONE ,WCH_NONE ,WCH_DEAD ,0x00c8   },
  {0xff         ,0      ,0x00c8   ,'3'      ,WCH_NONE ,WCH_NONE ,'`'      ,WCH_NONE },
  {'4'          ,SGCAPS ,0x00ea   ,'4'      ,WCH_NONE ,WCH_NONE ,'&'      ,0x00ca   },
  {'4'          ,0      ,0x00ca   ,'4'      },
  {'5'          ,0      ,'('      ,'5'      ,WCH_NONE ,WCH_NONE ,'['      ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,WCH_NONE ,WCH_NONE ,WCH_NONE ,0x02dd   },
  {'6'          ,0      ,')'      ,'6'      ,WCH_NONE ,WCH_NONE ,']'      ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,WCH_NONE ,WCH_NONE ,WCH_NONE ,0x02f5   },
  {'7'          ,0      ,0x2018   ,'7'      ,WCH_NONE ,WCH_NONE ,WCH_DEAD ,WCH_NONE },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,WCH_NONE ,WCH_NONE ,0x00af   ,WCH_NONE },
  {'8'          ,0      ,0x2019   ,'8'      ,WCH_NONE ,WCH_NONE ,'_'      ,0x2014   },
  {'9'          ,0      ,0x00ab   ,'9'      ,WCH_NONE ,WCH_NONE ,0x201c   ,0x2039   },
  {'0'          ,0      ,0x00bb   ,'0'      ,WCH_NONE ,0x0000   ,0x201d   ,0x203a   },
...
// aVkToWch3 and aVkToWch6) before considering the numpad (aVkToWch1).
